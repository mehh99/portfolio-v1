...
export const argTab = (
  ...
  // 7) if input is 'socials go '
    ...
    ["1.Github", "2.Linkedln", "3.Instagram"].forEach(t => {
      hintsCmds = [...hintsCmds, t];
    });
    return hintsCmds;
  }
  ...
  // 8) if input is 'projects go '
    ...
    [
      "1.Fragrance Clustering System Using K-Means Algorithm",
      "2.Scholarship Recipient Selection using TOPSIS Method",
      "3.Eligibility Determination for Program Keluarga Harapan (PKH)",
      "4.To-Do List",
      "5.Point of Sale API",
